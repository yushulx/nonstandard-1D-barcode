...
license_key = "LICENSE-KEY" # https://www.dynamsoft.com/CustomerPortal/Portal/Triallicense.aspx
    ...
    try:
        ...
        if text_results != None:
            for text_result in text_results:
                ...
                if is_standard: print(text_result.barcode_format_string)
                else: print(text_result.barcode_format_string_2 + '. Start/Stop character is ' + special_character + '.')
                print('')
                print('Barcode Text:')
